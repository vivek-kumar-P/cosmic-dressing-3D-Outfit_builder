...
const features = [
  ...
  },
  {
    icon: Sparkles,
    title: "3D Try-On",
    description: "See how clothes look with our 3D visualization. Rotate, zoom, and preview every detail before you buy.",
    link: "/3d-preview",
  ...
  },
  {
    icon: Users,
    title: "Style Gallery",
    description: "Browse curated outfits from the community, discover trending styles, and find your next look.",
    link: "/gallery",
